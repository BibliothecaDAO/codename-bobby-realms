...
mod types_tests {
    ...
    fn test_mint_start_time_store_packing_max_values() {
        ...
        let mint_start_time = MintStartTime {
            regular: BoundedInt::max(),
            whitelist: BoundedInt::max(),
        };
    ...
    fn test_mint_start_time_store_packing_random_values_1() {
        ...
        let mint_start_time = MintStartTime {
            regular: 0,
            whitelist: BoundedInt::max() - 781222222221,
        };
    ...
    fn test_mint_start_time_store_packing_random_values_2() {
        ...
        let mint_start_time = MintStartTime {
            regular: BoundedInt::max() - 98129017,
            whitelist: 0,
        };
    ...
    fn test_mint_start_time_store_packing_random_values_3() {
        ...
        let mint_start_time = MintStartTime {
            regular: BoundedInt::max() -49898182129017,
            whitelist: BoundedInt::max() - 90912222221,
        };
    ...
    fn test_supply_store_packing_max_values() {
        ...
        let supply = Supply {
            total_nft: BoundedInt::max(),
            custom_nft: BoundedInt::max()
        };
