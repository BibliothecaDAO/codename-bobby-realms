...
mod tests {
    ...
    use super::Seed;
    use super::{DescriptorRegular, IDescriptorRegularDispatcher, IDescriptorRegularDispatcherTrait};

    fn declare__deploy() -> IDescriptorRegularDispatcher {
    ...
    fn test_svg_image() {
        ...
        let image_svg = dispatcher.svg_image(seed);
