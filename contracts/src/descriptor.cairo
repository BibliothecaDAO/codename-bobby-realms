...
mod Descriptor {
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn data_uri(self: @ContractState, token_id: u256, seed: Seed) -> ByteArray {
            ...
            let attributes: Span<ByteArray> = self.construct_attributes(
                armour: armour_name, 
                mask: mask_name, 
        ...
        fn construct_image(self: @ContractState, armour: ByteArray, mask: ByteArray, background: ByteArray, jewellry: ByteArray, weapon: ByteArray, image_type: ImageType) -> ByteArray {
        ...
        fn construct_attributes(self: @ContractState, armour: ByteArray, mask: ByteArray, background: ByteArray, jewellry: ByteArray, weapon: ByteArray) -> Span<ByteArray> {
...
mod tests {
    ...
    fn test_token_uri_no_image() {
        ...
        let metadata
            = dispatcher
                .token_uri_no_image(44, seed);
            
        assert!(metadata == "data:application/json;base64,");
    }
